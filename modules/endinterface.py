...
def showEndInterface(screen, cfg,score,highest_score):
    ...
    text_restart = font_small.render(f"Press A for restart the game and Press Q to quit the game",True, (255,0,0))
    text_restart_rect = text_restart.get_rect()
    text_restart_rect.centerx = screen.get_rect().centerx 
    text_restart_rect.centery = screen.get_rect().centery +60
